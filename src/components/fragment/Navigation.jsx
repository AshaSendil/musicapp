...
import '../../components/fragment/css/Navigation.scss'
...
function Navigation() {
    ...
    return (
        <nav style={useStyle.component} className="navigation_top">
            {/* <Brand/> */}
            <SideBar/>
            ...
            <div className={"language"} onClick={handleOpenLanguageList}>
                <Button>
                    <div className="wrapper">
                        <button className="upgrade_to_premium">Upgrade To Premium</button>
                    </div>
                </Button>
                {/* {
                    isLanguageListOpen
